...
public class CSkill {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody dtoSkill dtohys) {
        ...
        Skill hYs = new Skill(dtohys.getNombre(), dtohys.getPorcentaje());
        shys.save(hYs);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoSkill dtohys) {
